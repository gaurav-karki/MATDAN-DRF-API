...
class Election(models.Model):
    ...
    abi_interface = models.JSONField(
        help_text="smart contract ABI for web 3 Interaction", null=True, blank=True
    )
...
class Candidate(models.Model):
    ...
    photo_url = models.ImageField(
        upload_to="candidate_pictures/", blank=True, null=True
    )
