...
class CustomAuthToken(ObtainAuthToken):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            logger.error("Authentication failed for user: %s. Error: %s", request.data.get('username'), str(e))
...
class UserRegistrationView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            logger.info("User registered sucessfully -> %s", request.data.get('username'))
            return response
        except Exception as e:
            logger.error("User registration failed for %s. Error: %s", request.data.get('username'), str(e))
            raise
